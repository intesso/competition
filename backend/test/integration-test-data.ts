...
const integrationTests = `newman run ${workingDir}/competition-test-data.postman_collection.json -e ${workingDir}/competition-local.postman_environment.json --export-environment ${workingDir}/tmp.env.json`
